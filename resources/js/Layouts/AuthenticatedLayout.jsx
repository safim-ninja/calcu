            ...
            {header && (
                <header className="bg-white dark:bg-slate-800 shadow">
                    <div className={'flex content-center'}>
                        <div className="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8 content-center">{header}</div>
                        <div className="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
                            <Link href={route('expenses.create')}
                                className="relative inline-flex items-center justify-center p-0.5 me-2 overflow-hidden text-sm font-medium text-slate-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 dark:group-hover:from-blue-500 dark:group-hover:to-purple-600 dark:group-focus:from-blue-500 dark:group-focus:to-purple-600 hover:text-white dark:text-white">
                                <span
                                    className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-slate-900 rounded-md group-hover:bg-opacity-0">
                                New Expense
                            </span>
                            </Link>
                        </div>
